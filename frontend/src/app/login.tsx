...
// 🌐 تم تعديل العنوان ليتطابق مع سيرفر بايثون المحلي لتجنب خطأ الاتصال
...
export default function App() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.ok) {
        // 💾 حفظ بيانات المستخدم في التخزين المحلي للجهاز
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (response.ok) {
        // عند نجاح التسجيل، يتم تسجيل الدخول وحفظ البيانات تلقائياً
        await handleLogin();
      } else {
